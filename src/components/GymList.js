...
const GymList = () => {
  ...
  return (
    <div className="gym-wrapper">
      ...
      {/* Contador */}
      <p className="text-right mr-3">Total: {gyms.length}</p>
                ...
                <div className="gym-details-container">
                  ...
                  <p className="p-title">
                    <Icon
                      ...
                      className="mr-1"
                    />{" "}
                    <a href={gym.website} target="no_blank">
                      Website
                    </a>
                  </p>
                  ...
                  <div
                    className="gym-gallery-container"
                    style={{
                      padding: "20px",
                      background:
                        "linear-gradient(to right, rgb(11, 7, 39), #1c1c1c)",
                      color: "#f5f5dc",
                      boxShadow: "0 4px 15px rgba(0, 0, 0, 0.3)",
                      borderRadius: "8px", // Adicionando bordas arredondadas para um visual moderno
                    }}
                  >
